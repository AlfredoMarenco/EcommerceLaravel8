...
<section class="section-content bg-white padding-y">
    ...
    <article class="gallery-wrap"> 
        <div class="img-big-wrap">
          <div> <a href="#"><img src="images/items/tablones-1.png"></a></div>
        </div> <!-- slider-product.// -->
        <div class="thumbs-wrap">
          <a href="#" class="item-thumb"> <img src="images/items/tablones-2.png"></a>
          <a href="#" class="item-thumb"> <img src="images/items/tablones-3.png"></a>
          <a href="#" class="item-thumb"> <img src="images/items/tablones-4.png"></a>
        </div> <!-- slider-nav.// -->
    ...
    <h2 class="title mt-3">Tablones de madera </h2>
