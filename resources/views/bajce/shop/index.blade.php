...
<section class="section-content padding-y">
    ...
    <div class="row">
        ...
        <article class="filter-group">
            <h6 class="title">
                <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#collapse_2"> Marcas </a>
            </h6>
        ...
        <article class="filter-group">
            <h6 class="title">
                <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#collapse_3"> Rango de precio </a>
            </h6>
    ...
    <div class="row">
        <div class="col-md-3">
            <figure class="card card-product-grid">
                <div class="img-wrap"> 
                    ...
                    <a href="/producto"><img src="images/items/bridas.png"></a>
                </div> <!-- img-wrap.// -->
                <figcaption class="info-wrap">
                        <a href="/producto" class="title mb-2">BISAGRAS NEGRAS</a>
                        ...
                        <a href="/carrito" class="btn btn-block btn-primary"> <i class="fas fa-cart-plus"></i> Agregar al carrito </a>	
        ...
        <div class="col-md-3">
            <figure class="card card-product-grid">
                ...
                <figcaption class="info-wrap">
                        <a href="/producto" class="title mb-2">BRIDAS PARA TUBO OVAL GRIS 7.5 X 2.3 CM</a>
                        <div class="price-wrap">
                            <span class="price">$350.00</span> 
                            <small class="text-muted">/ pza</small>
        ...
        <div class="col-md-3">
            <figure class="card card-product-grid">
                ...
                <figcaption class="info-wrap">
                        <a href="#" class="title mb-2">BRIDAS PARA TUBO OVAL GRIS 7.5 X 2.3 CM</a>
                        <div class="price-wrap">
                            <span class="price">$350.00</span> 
                            <small class="text-muted">/ pza</small>
