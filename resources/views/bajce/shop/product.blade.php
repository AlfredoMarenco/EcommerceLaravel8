...
<section class="py-3 bg-light">
  ...
  <article class="gallery-wrap"> 
      <div class="img-big-wrap">
        <div> <a href="#"><img src="images/items/bisagras.png"></a></div>
      </div> <!-- slider-product.// -->
      <div class="thumbs-wrap">
        <a href="#" class="item-thumb"> <img src="images/items/bisagras.png"></a>
        <a href="#" class="item-thumb"> <img src="images/items/bisagras.png"></a>
        <a href="#" class="item-thumb"> <img src="images/items/bisagras.png"></a>
        <a href="#" class="item-thumb"> <img src="images/items/bisagras.png"></a>
      </div> <!-- slider-nav.// -->
  ...
  <h2 class="title mt-3">BISAGRAS NEGRAS </h2>
  ...
  <div class="rating-wrap my-3">
      ...
      <small class="label-rating text-success"> <i class="fa fa-clipboard-check"></i> Envío gratis en zona Mérida </small>
  </div> <!-- rating-wrap.// -->
  
  <div class="mb-3"> 
      <var class="price h4">MXN 350.00</var> 
  ...
  <div class="row">
      ...
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur ipsa voluptatem blanditiis perferendis, ea distinctio quas enim illum repellendus deserunt veniam quos! Molestiae maiores esse nostrum doloribus dolorum dicta atque.</p>
      <div class="rating-wrap my-3">
        <ul class="rating-stars">
          <li style="width:80%" class="stars-active"> 
            <i class="fa fa-star"></i> <i class="fa fa-star"></i> 
