...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('mercadopago/css/index.css') }}">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    <script src="https://sdk.mercadopago.com/js/v2"></script>
    <script type="text/javascript" src="{{ asset('mercadopago/js/index.js') }}" defer></script>
...
<body>
    ...
    <footer>
        <div class="footer_logo"><img id="horizontal_logo" src="{{ asset('mercadopago/img/horizontal_logo.png') }}">
        </div>
