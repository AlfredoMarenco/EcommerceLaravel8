...
<div class="row mb-3">
    ...
    <div class="form-row p-3">
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('folio_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
            @error('folio_visible')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('categoria_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('ficha_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
            @error('ficha')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('garantia_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('usos_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
            @error('usos_visible')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('contenido_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('montaje_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('capacidad_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('marca_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
            @error('marca_visible')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('material_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('medidas_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('medidasmodulo_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::select('acabado_visible', [1 => 'Si', 0 => 'No'], 0, ['class' => 'form-control']) !!}
