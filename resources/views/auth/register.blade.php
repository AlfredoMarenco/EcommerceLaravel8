...
@section('content')
                ...
                <div class="form-group">
                    <label class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input"
                            checked="">
                        <div class="custom-control-label text-dark"> Estoy de acuerdo con los <a href="{{ route('login') }}">terminos y
                                condiciones</a> </div>
                    </label>
                </div>
                <!-- form-group end.// -->
    ...
    <!-- card .// -->
    <p class="text-center mt-4">Ya tienes cuenta? <a href="">Iniciar sesión</a></p>
    <br><br>
